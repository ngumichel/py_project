...
narrow_column_name_2 = ['ville_nom', 'ville_population_2012', 'Code commune', 'ville_longitude_deg', 'ville_latitude_deg']

def extract_and_prepare_cities_from_csv(data_file):
    cities = dt.read_csv_file(data_file, column_name, ",", None)
...
def format_cities_data(cities):
    ...
    return dt.narrow_data_column(selected_cities, narrow_column_name_2)
